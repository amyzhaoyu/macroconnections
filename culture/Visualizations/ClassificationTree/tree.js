...
var u = "https://docs.google.com/spreadsheet/pub?key=0AgfOXjbH2KOddHR3c0JDbGpLa3E1UkVpUjRhaE5JeEE&single=true&gid=0&output=csv";
function renderTree(url){
  ...
  $.get(url,{}, function (d) { 
    ...
    var vis = d3.select("#body").append("svg:svg").attr("id", "tree")
